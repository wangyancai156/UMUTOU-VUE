...
namespace WangYc.Models.BW {
    public class PurchaseNoticeDetail : EntityBase<int>, IAggregateRoot {
        ...
        public PurchaseNoticeDetail() { }

        public PurchaseNoticeDetail(PurchaseOrderDetail purchaseOrder, int qty, string createUserId) {
